      ...
      <div id="p-home" className="page container">
        <div className="p-home__welcome-col">
          <VStack spacing={2}>
            ...
            <PostInput placeholder={fider.session.tenant.invitation || defaultInvitation} onTitleChanged={setTitle} boardNumber={props.boardNumber} />
        ...
        <div className="p-home__posts-col">
          {isLonely() ? (
            ...
            <SimilarPosts title={title} tags={props.tags} boardNumber={props.boardNumber} />
          ) : (
            <PostsContainer boardNumber={props.boardNumber} posts={props.posts} tags={props.tags} countPerStatus={props.countPerStatus} />
          )}
